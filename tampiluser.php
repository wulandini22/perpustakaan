    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">.: Daftar Petugas Perpustakaan:.</h2>
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                            <?php
                                                $sql = "SELECT * FROM tbuser Order by NmUser Asc";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" onclick="confirmDelete('<?php echo $nip; ?>')">
                                                            <button class="btn btn-danger">hapus</button>
                                                        </a>
                                                        <a href="edituser.php?nip=<?php print($nip);?>">
        ...
        <script>
                    function confirmDelete(nip) {
                        var result = confirm("Apakah Anda yakin akan menghapus data user ini?");

                        if (result) {
                            window.location.href = 'hapususer.php?nip=' + nip;
                        }
                    }
                </script>
    </body>
