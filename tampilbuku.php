...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                    ...
                                    <tbody>
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="editbuku.php?KdBuku=<?php print($kdbuku);?>">
                                                        <button class="btn btn-warning">edit</button>
                                                    </a>
                                                    <a href="#" onclick="confirmDelete('<?php echo $kdbuku; ?>')">
        ...
        <script>
                    function confirmDelete(kdbuku) {
                        var result = confirm("Apakah Anda yakin akan menghapus data anggota ini?");

                        if (result) {
                            window.location.href = 'hapusbuku.php?KdBuku=' + kdbuku;
                        }
                    }
        </script>
    </body>
