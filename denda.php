...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
                ...
                include('koneksi.php');
                $id = $_GET['id_pinjam'];
                $query = "SELECT * FROM tbtransaksi WHERE id_pinjam='".$id."'";
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid px-4">
                            ...
                            <form role="form" enctype="multipart/form-data" method="post" action="bayardenda.php">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tdenda" value="<?php echo $denda; ?>" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="formGroupExampleInput2" class="form-label">Metode Pembayaran</label>
                                    <select class="form-select" name="tmetode" required>
                                        <option value="tidak memiliki denda"> </option>
