                    ...
                    <div id="layoutSidenav_content">
                        <main>
                            <div class="container-fluid px-4">
                                <h2 class="mt-4">.: Form Input Anggota :.</h2> <BR>
                                <form role="form" enctype="multipart/form-data" method="post" action="simpananggota.php">
                                    <div class="mb-3">
                                    <label for="formGroupExampleInput2" class="form-label">No Anggota</label>
                                    <input type="text" class="form-control" name="tnoanggota" placeholder="Kolom isian nomor anggota" required>
                                    </div>
                                    <div class="mb-3">
                                    <label for="formGroupExampleInput2" class="form-label">Nama Anggota</label>
                                    <input type="text" class="form-control" name="tnmanggota" placeholder="Kolom isian nama anggota" required>
                                    </div>
                                    <div class="mb-3">
                                    <label for="formGroupExampleInput2" class="form-label">NIS</label>
                                    <input type="text" class="form-control" name="tnis" placeholder="Kolom isian NIS" required>
                                    </div>
                                    <div class="mb-3">
                                    <label for="formGroupExampleInput2" class="form-label">Tempat Lahir</label>
                                    <input type="text" class="form-control" name="ttmp" placeholder="Kolom isian tempat lahir" required>
                                    </div>
                                    <div class="mb-3">
                                    <label for="formGroupExampleInput2" class="form-label">Tanggal Lahir</label>
                                    <input type="date" class="form-control" name="ttgl" placeholder="Kolom isian nik petugas" required>
                                    </div>
                                    <div class="mb-3">
