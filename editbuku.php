            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">.: Form Edit Buku :.</h2> <BR>
                        <form role="form" enctype="multipart/form-data" method="post" action="simpaneditbuku.php">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="tnmbuku" value="<?php echo $nama; ?>" required>
                            </div>
                            <div class="mb-3">
                              <label for="formGroupExampleInput2" class="form-label">Pengarang</label>
                              <input type="text" class="form-control" name="tpengarang" value="<?php echo $pengarang; ?>" required>
                            </div>
                            <div class="mb-3">
                              <label for="formGroupExampleInput2" class="form-label">Penerbit</label>
                              <input type="text" class="form-control" name="tpenerbit" value="<?php echo $penerbit; ?>" required>
                            </div>
                            <div class="mb-3">
                              <label for="formGroupExampleInput2" class="form-label">Tahun Terbit</label>
                             <input type="text" class="form-control" name="ttahun" value="<?php echo $tahun; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Edisi</label>
                               <input type="text" class="form-control" name="tedisi" value="<?php echo $edisi; ?>" required>
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Jumlah Halaman</label>
                               <input type="text" class="form-control" name="tjml" value="<?php echo $jmlhal; ?>" required>
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Jumlah Eksamplar</label>
                               <input type="text" class="form-control" name="teks" value="<?php echo $jmleks; ?>" required>
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Jenis</label>
                               <input type="text" class="form-control" name="tjenis" value="<?php echo $jenis; ?>" required>
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Cover Buku</label>
                               <input type="file" class="form-control" name="tcover" value="<?php echo $cover; ?>" required>
                              </div>
                            <br>
