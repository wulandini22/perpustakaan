            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">.: Form Peminjaman Buku :.</h2> <BR>
                        <form role="form" enctype="multipart/form-data" method="post" action="simpanpinjam.php">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="date" class="form-control" name="tpinjam" value="<?php echo date('Y-m-d'); ?>" required>
                            </div>
                            <div class="mb-3">
                              <label for="formGroupExampleInput2" class="form-label">Tanggal Pengembalian</label>
                              <input type="date" class="form-control" name="tkembali" value="<?php echo date('Y-m-d', strtotime('+7 days')); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Jumlah Buku</label>
                               <input type="text" class="form-control" name="tjml" value="1" required>
                              </div>
                            <br>
