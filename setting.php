            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">.:User Profile:.</h2> <BR>
                        <form role="form" enctype="multipart/form-data" method="post" action="simpanedituser.php">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="tnip" value="<?php echo $nip; ?>" readonly>
                            </div>
                            <div class="mb-3">
                              <label for="formGroupExampleInput2" class="form-label">Nama User</label>
                              <input type="text" class="form-control" name="tnmuser" value="<?php echo $namaUser; ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="tpass" value="<?php echo $password?>" required>
                            </div>
                            <div class="mb-3">
