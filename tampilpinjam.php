            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">.: Daftar Peminjaman Buku:.</h2>
                        <a href="cetak-laporan.php"><button class="btn btn-danger">Cetak Laporan</button><a>
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <body>
                                            <?php
                                                $sql = "SELECT * FROM tbtransaksi Order by id_pinjam Asc";
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php print($pinjam);?></td>
                                                    <td><?php print($kembali);?></td>
                                                    <td><?php print($tgl);?></td>
                                                    <td><?php print($jml);?></td>
                                                    <td><?php print($denda);?></td>
                                                    <td><?php print($stat); ?></td>
                                                    <td><a href="pengembalian.php?KdBuku=<?php print($kdbuku);?>">
